...
<div style="display: flex; align-items: center; gap: 20px; flex-wrap: wrap;">
  ...
  <img src="IMG_1724.jpeg" alt="My Photo" style="width: 150px; border-radius: 10px;" />
...
I am a graduate student in the [Department of Electrical and Computer Engineering](https://www.ece.cmu.edu/) at [Carnegie Mellon University](https://www.cmu.edu/), pursuing a Masters in [AI Engineering](https://www.ece.cmu.edu/academics/ms-ai/standard-program.html). 
...
I'm interning at **Apical Intelligence** (formerly Numenta) for Summer 2026, specializing in the pre-training of sparse Large Language Models. 
...
I've been a part of the [OPAL Lab](https://www.andrew.cmu.edu/user/gaurij/Group.html) at CMU since June 2025, working under the guidance of [Dr. Gauri Joshi](https://www.andrew.cmu.edu/user/gaurij/). My research includes 1) Diffusion Language Models, 2) Improving the performance of LLM judges, and 3) enhancing LLM Inference in terms of both speed and output quality using CRITICS and Infilling.
...
utility in signal processing, as well as in normalizing flows, and matrix rigidity. Supported by the Qualcomm 6G University India Research Program, I spent 10 months working on Algebraic Error Correcting Codes. This work was conducted under the guidance of [Dr. Lakshmi Prasad Natarajan](https://people.iith.ac.in/lakshminatarajan/) and in direct collaboration with researchers at **Qualcomm**. Further details regarding this project can be found in the publications and projects sections.
